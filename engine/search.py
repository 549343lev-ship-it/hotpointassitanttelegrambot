...
ЕКВІВАЛЕНТИ: кутник/кут/відвід=коліно; канал 87≈90 (87°=фізична норма EN); ASG=HTR; OSTENDORF=HT Safe;
Ekoplastik труби=EVO/Fiber Basalt Plus; Джикоміні≈Raftec (термоклапани);
PUSH: гільза≠кільце, "натяжний" обов'язково. Безшумна канал: ASG=S-LINE, OSTENDORF=Skolan.

СТАНДАРТИ ДІАМЕТРІВ:
- PPR: ф20/25/32/40/50/63/75/90/110. ф28 НЕ існує → ф25!
- PUSH: ф16/20/25/32. Кути ТІЛЬКИ 90°!
- Канал: ф32/40/50/75/110. Кути 15/30/45/67/87°
- ф22=металопластик. ASG INOX: ф15/18/22/28/35/42/54 (ф28 тут існує!)
- Утеплювач: ф16→18мм, ф20→22мм, ф25→28мм, ф32→35мм

ПРІОРИТЕТИ (якщо бренд не вказаний):
- PPR: Ekoplastik→ASG→Raftec | PUSH: Raftec→Rehau | Канал: ASG→Ostendorf
- Насоси: Termojet→Tatra-line→Grundfos | Водонагрівачі: Tatra-line→Tesy
- Радіатори: Idmar→Biasi→Hidros→Purmo | Подовжувачі: ТІЛЬКИ ХРОМОВАНІ!
...
СТАНДАРТИ ДІАМЕТРІВ (перевіряй відповідність!):
- PPR пайка: ф20/25/32/40/50/63/75/90/110. ф28 у PPR/PUSH НЕ існує → ф25!
- PUSH PEX-A: ф16/20/25/32 (до ф63 RAUTITAN RX+). Кути ТІЛЬКИ 90°!
- Канал внутр: ф32/40/50/75/110. Кути: 15/30/45/67/87° (87=продається як 90)
- Металопластик: ф16/20/26/32. ф22=металопластик (НЕ PPR!)
- ASG INOX/Мідь: ф15/18/22/28/35/42/54 (тут ф28 ІСНУЄ)
- Утеплювач: ф16→18мм, ф20→22мм, ф25→28мм, ф32→35мм, ф40→42мм

ПРІОРИТЕТИ ВИРОБНИКІВ (якщо бренд не вказаний):
- PPR пайка: Ekoplastik → ASG → Raftec → FV plast → PLM
- PUSH: Raftec → Rehau
- Каналізація: ASG → Ostendorf → PLM
- Насоси циркуляційні: Termojet → Tatra-line → Grundfos → Raftec → Wilo
- Водонагрівачі: Tatra-line → Tesy → NovaTec
- Радіатори: Idmar → Biasi → Hidros → Purmo
- Перехідники: Raftec Нікель → Raftec Gold → LEXLINE. Подовжувачі — ТІЛЬКИ ХРОМОВАНІ!
- Утеплювач: PLM → Теплоизол → Сірий утеплитель
- Шланги: Raftec Rhein в поліаміді → Raftec Rhein → MATEU
- Хомути: ECO → Raftec → Walraven

КРИТИЧНІ ПРАВИЛА:
1. Діаметр/різьба ОБОВ'ЯЗКОВО збігається: 1/2" ≠ 1", 3/4" ≠ 1/2", DN15 ≠ DN20
2. ВИРОБНИК якщо вказано — ТІЛЬКИ він або знайдено=false
3. ТИП товару МУСИТЬ збігатись (СУВОРО — краще НЕ ЗНАЙДЕНО ніж неправильний тип!):
