...
3. ТИП товару МУСИТЬ збігатись:
   - ніпель/футорка/подовжувач ≠ ножиці/муфта/американка
   - гідроакумулятор/розширювальний бак ≠ термостат/мембрана
   - радіатор біметалічний ≠ алюмінієвий
   - зворотний клапан ≠ змішувальний/триходовий клапан
