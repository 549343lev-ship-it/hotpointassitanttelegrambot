...
print("📦 Імпортую engine/bot.py...", flush=True)
from engine.bot import bot as tg_bot
print(f"✅ OK, зареєстровано handlers: {len(tg_bot.message_handlers)}", flush=True)
...
def webhook():
    ...
    try:
        ...
        if m:
            ...
            print(f"📥 upd {uid}: callback={update.callback_query.data!r}", flush=True)
    except Exception:
        pass
